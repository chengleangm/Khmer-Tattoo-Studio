...
export default function ArtistCard({ name, specialty, years, image }: ArtistCardProps) {
  return (
    <article className="group min-w-0 border border-ink/10 bg-bone">
      ...
      <div className="p-3 sm:p-5">
        ...
        <p className="mt-1 font-condensed text-[0.68rem] uppercase leading-tight tracking-editorial text-teal sm:text-base">
          {specialty}
        </p>
